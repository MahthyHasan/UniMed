...
export default function Prescription() {
	...
	const registerMedicalRecord = async () => {
		...
		const transformedPrescribedDrugs = prescribedDrugs.map(drug => 
			...
			<div className="container-fluid">
				...
				<div className="row">
					<div className="col d-flex justify-content-end mt-3">
						<IssuedButton onClick={registerMedicalRecord} />
            <button onClick={registerMedicalRecord} >test Button</button>
					</div>
				</div>
			</div>
		</Layout>
