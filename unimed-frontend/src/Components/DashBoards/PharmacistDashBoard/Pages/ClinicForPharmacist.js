                ...
                {!showMedicineScanner && !showBookingScanner ? (
                    <div className="row justify-content-center">
                        <div className="col-12 col-md-6">
                            <div className="p-3" onClick={() => handleScancardClick('medicine')}>
                                <ScancardQr />
                            </div>
                        </div>
                        <div className="col-12 col-md-6">
                            <div className="p-3" onClick={() => handleScancardClick('booking')}>
                                <ScancardQr2 />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row justify-content-center">
                        {showMedicineScanner ? (
                            <div className="col-12 col-md-6">
                                <div>
                                    <QrcodeScannerForMedicine setShowQrDiv={() => setShowMedicineScanner(false)} />
                                </div>
                            </div>
                        ) : (
                            <div className="col-12 col-md-6">
                                <div>
                                    <QrcodeScannerForBooking setShowQrDiv={() => setShowBookingScanner(false)} />
                                </div>
                            </div>
                        )}
                    </div>
